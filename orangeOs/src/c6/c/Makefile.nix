...
# Param
AIMG:=$(DOSUTIL)/mdisk/a.img
FLOPPY:=/mnt/floppy/

# All Phony Targets
.PHONY : everything final image clean realclean disasm all buildimg stage1 stage2 stage3 one two three
...
buildimg :
	dd if=boot/boot.bin of=$(AIMG) bs=512 count=1 conv=notrunc
	sudo mount -t msdos -o loop $(AIMG) $(FLOPPY)
