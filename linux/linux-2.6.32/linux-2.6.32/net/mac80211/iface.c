...
static const struct net_device_ops ieee80211_dataif_ops = {
	...
	.ndo_start_xmit		= ieee80211_subif_start_xmit,//lux 发包
				  ...
				  enum nl80211_iftype type)
{
	...
	sdata->vif.type = type;
	sdata->dev->netdev_ops = &ieee80211_dataif_ops;//lux 绑定操作类
...
/** lux 新增设备
 * @param ieee80211_local
 * @param const char
 * @param net_device
 * @param enum nl80211_iftype
 * @param vif_params
 */ 
		     ...
		     struct vif_params *params)
{
	...
	ieee80211_setup_sdata(sdata, type);//lux 初始化

	ret = register_netdevice(ndev);//lux 注册该设备
	if (ret)
		goto fail;
