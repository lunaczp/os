/*lux SOCKET的网络层定义(Netwrok Layer)
 */
/*
...
#define NPROTO		AF_MAX	/*lux 可以注册的net proto family个数最大值*/
...
/**
 * lux 协议簇下的一类proto使用共同的proto_ops, 
 * 如INET下的inet_stream_ops, inet_dgram_ops, inet_sockraw_ops,
...
/**
 * lux 网络协议簇,如INET、UNIX DOMAIN,etc
 * 每个协议簇又包含了具体的协议，如INET包含了TCP、UDP、ICMP、etc
 */
struct net_proto_family {
	int		family;//lux 协议簇
	int		(*create)(struct net *net, struct socket *sock, int protocol);//lux create用来创建协议簇内的某个具体协议
	struct module	*owner;
};
